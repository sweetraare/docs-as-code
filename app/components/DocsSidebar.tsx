        ...
        {slugs.map((slug) => {
          ...
          return (
            <li key={`${base}-${slug}`}>
              <Link
                href={href}
                className={`group flex items-center py-2 text-sm rounded-md transition-all ${
                  isActive
              ...
              >
                ...
                {isActive && (
                  <span className="w-1 h-4 bg-indigo-500 absolute left-0 rounded-r-full" />
                )}
